...
excel_path = "vehicle-inspections.xlsx"
ordered_data = []

url = f"{base_url}api/v1/vehicle/{inspection_type}?page=1&limit=10000"
...
if response.status_code == 200:
    ...
    for n in range(2, last_page + 1):
        ...
        url = f"{base_url}api/v1/vehicle/{inspection_type}?page={n}&limit=10000"
        response = requests.get(url, headers=headers)
...
if ordered_data:
    ...
    print("No se obtuvieron datos para el mes solicitado.")